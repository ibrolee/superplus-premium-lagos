...
const common: GuideEntry[] = [
  ...
  entry('join','How to become a member','On the Join page, choose your plan, enter your details and complete payment through verified Paystack checkout. Your membership activates after payment verification. Previously enrolled offline? Ask reception to find your existing profile before renewing so you do not create a duplicate record.','/join',['join','sign up','signup','register','become member','become a member','new member','enroll','enrol','start membership','how to join','subscribe'],'Join online'),
  entry('renew','Renew an existing membership','Sign into your existing member account and renew from the member dashboard, or ask reception to find your existing profile and renew it directly after confirmed payment. Existing members do not pay another registration fee.','/login',['renew','renewal','extend','existing member','old member','returning member','again','already a member','registration fee again','previous membership'],'Member login'),
  entry('payment','Paying for membership','New members can use secure Paystack checkout on the Join page. For cash, POS or transfer at reception, staff confirm the gym has actually received the money before recording the successful payment and activating the membership. A transfer screenshot alone is not enough.','/join',['pay','payment','paystack','card','bank transfer','transfer','cash','pos','payment methods','online payment','checkout','receipt','payment confirmation'],'Join and pay securely'),
