...
export function SiteMotion() {
  ...
  return pathname === "/" && showBackToTop ? <button
    ...
    className="fixed bottom-[calc(1.25rem+env(safe-area-inset-bottom))] right-5 z-40 flex size-12 items-center justify-center rounded-full border border-white/20 bg-secondary text-white shadow-lg shadow-black/25 transition-colors hover:bg-primary focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary sm:bottom-7 sm:right-7"
