...
const actions: Action[] = [
  ...
  { label: "Review missed-scan requests", href: "/staff-missed-scans", description: "Approve or reject staff explanations without changing QR records", keywords: "forgotten scan approve reject management request", management: true },
