...
export const actions: Action[] = [
 ...
 { label:'Register or renew',href:'/reception-register',description:'Register a new member or renew an existing member directly without approval',keywords:'registration join renewal cash transfer pos direct membership coupon',category:'Members & memberships',access:'reception',quick:true },
