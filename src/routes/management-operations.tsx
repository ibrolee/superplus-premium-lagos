...
function ManagementOperations() {
  ...
  const dailyActions: Action[] = [
    ...
    { label: "Public Join page", description: "New online customers can create a profile and pay through Paystack. REGSF removes only the registration fee.", href: "/join", icon: CreditCard, eyebrow: "Online registration" },
