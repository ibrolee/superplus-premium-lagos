...
function PortalPasswordReset() {
  ...
  return (
    <main className="min-h-[70vh] bg-[#f4f6f1] px-4 py-12 text-[#183125]">
        ...
        {success ? (
          <div role="status" className="mt-5">
            <p className="text-sm leading-6">
              Password updated. Sign in through your assigned portal.
            </p>
            <Link
              to="/portal"
              className="mt-5 inline-flex rounded-xl bg-[#193b2a] px-5 py-3 text-sm font-bold text-white"
            >
              Choose your portal
            </Link>
          </div>
          ...
          <form onSubmit={submit} className="mt-6 grid gap-4">
            ...
            <button
              type="submit"
              disabled={busy}
              className="rounded-xl bg-[#193b2a] p-3 font-bold text-white disabled:opacity-60"
            >
          ...
          <div className="mt-5 text-sm leading-6">
            <p>
              Open the password-reset link from your email. If it has expired, request another from
              your login page.
            </p>
            <Link to="/portal" className="mt-4 inline-flex font-bold text-[#27643a] underline">
              Choose your portal
            </Link>
          </div>
        )}
