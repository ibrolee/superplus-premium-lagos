          ...
          <>
            ...
            {featuredPost && (
              <section className="mb-14">
                ...
                {/* Native link deliberately used here so the whole card is clickable */}
                <a
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {regularPosts.map((post) => (
                    <a
                      ...
                      className="group block overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
                    >
