    ...
    <div className="mx-auto flex min-h-screen min-w-0 max-w-[1680px] flex-col lg:flex-row">
      <aside className="min-w-0 border-b border-[#243b32] bg-[#152820] px-5 py-5 text-white lg:sticky lg:top-0 lg:flex lg:h-screen lg:w-64 lg:flex-col lg:border-b-0 lg:px-6 lg:py-8">
        ...
        <nav aria-label="Management navigation" className="mt-4 flex gap-2 overflow-x-auto pb-1 lg:flex-col lg:overflow-visible">
          ...
          <a href="/reception-register" className="flex shrink-0 items-center gap-3 rounded-xl px-4 py-3 text-sm text-[#d5e3d8] hover:bg-white/10"><UserPlus size={17}/> Register / renew</a>
      ...
      <main className="min-w-0 flex-1 px-4 py-7 sm:px-7 lg:px-10 lg:py-10">
        ...
        {!loading && role && !error && <>
          ...
          <section className="mt-6 rounded-[24px] border border-[#e1e8dd] bg-white p-4 sm:p-7"><div className="flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-xl font-black">All member records</h2><p className="mt-1 text-xs text-[#748276]">Search before registering so reception avoids duplicate profiles.</p></div><a href="/reception-register" className="inline-flex items-center gap-2 rounded-xl bg-[#1a3226] px-4 py-3 text-sm font-bold text-white"><UserPlus size={17}/> Register / renew</a></div>
