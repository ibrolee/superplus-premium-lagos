    ...
    <div className="mx-auto flex min-h-screen max-w-[1680px] flex-col lg:flex-row">
      ...
      <main className="min-w-0 flex-1 px-4 py-7 sm:px-7 lg:px-10 lg:py-10">
        ...
        {!loading && role && !error && <>
          ...
          <section className="mt-6 rounded-[24px] border border-[#e1e8dd] bg-white p-4 sm:p-7"><div className="flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-xl font-black">All member records</h2><p className="mt-1 text-xs text-[#748276]">Read-only directory · edits and payments use the existing member tools.</p></div><a href="/reception-dashboard" className="inline-flex items-center gap-2 rounded-xl bg-[#1a3226] px-4 py-3 text-sm font-bold text-white"><UserPlus size={17}/> Registration & renewals</a></div>
