        ...
        {!loading && authorized && (
          <>
            ...
            <section className="mt-6 rounded-[24px] border border-[#e1e8dd] bg-white p-5 sm:p-7">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <h2 className="text-xl font-black">Revenue by source</h2>
                <a
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {breakdown.map((item) => (
                  <div
                    key={item.source}
                    className="rounded-xl border border-[#e2e9dd] bg-[#f8faf6] p-4"
                  >
                    <p className="text-xs font-bold text-[#607465]">{sourceLabels[item.source]}</p>
